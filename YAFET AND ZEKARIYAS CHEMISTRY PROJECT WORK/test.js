...
const message = prompt ("Enter the symbol for the element?");
const result = data.elements.filter(e => e.symbol == message)
// Update header text)
document.querySelector('#name').innerHTML =JSON.stringify(result[0].name) 
document.querySelector('#boil').innerHTML =JSON.stringify(result[0].boil) 
document.querySelector('#phase').innerHTML =JSON.stringify(result[0].phase)
document.querySelector('#melt').innerHTML =JSON.stringify(result[0].melt)
document.querySelector('#category').innerHTML =JSON.stringify(result[0].category)
document.querySelector('#symbol').innerHTML =JSON.stringify(result[0].symbol)
document.querySelector('#density').innerHTML =JSON.stringify(result[0].density)
document.querySelector('#electron_affinity').innerHTML =JSON.stringify(result[0].electron_affinity)
document.querySelector('#electron_configuration').innerHTML =JSON.stringify(result[0].electron_configuration)
document.querySelector('#summary').innerHTML =JSON.stringify(result[0].summary)
document.querySelector('#named_by').innerHTML =JSON.stringify(result[0].named_by)
document.querySelector('#discovered_by').innerHTML =JSON.stringify(result[0].discovered_by)
// Log to console
console.log(message)
